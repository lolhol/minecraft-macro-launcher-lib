...
describe('Artifact', () => {
  describe('#from', () => {
    ...
    it('should be able to resolve artifact from artifact id with classifier', () => {
      ...
      const path =
        'org/lwjgl/lwjgl-jemalloc/3.2.1/lwjgl-jemalloc-3.2.1-sources.jar';
    ...
    it('should be able to resolve artifact from artifact id with classifier and custom extension', () => {
      const artifact = Artifact.from(
        'org.lwjgl:lwjgl-jemalloc:3.2.1:sources@tar.xz'
      );
      const path =
        'org/lwjgl/lwjgl-jemalloc/3.2.1/lwjgl-jemalloc-3.2.1-sources.tar.xz';
    ...
    it('should be able to resolve artifact from normal artifact object', () => {
      ...
      const { path, sha1, size, url } = Artifact.from(artifact);
