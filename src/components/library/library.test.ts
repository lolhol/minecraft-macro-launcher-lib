...
describe('Library', () => {
  describe('#from', () => {
    ...
    it('should be able to resolve forge library', () => {
      ...
      const url =
        'https://modloaders.forgecdn.net/647622546/maven/net/minecraftforge/forge/1.14.4-28.2.0/forge-1.14.4-28.2.0.jar';
  ...
  describe('#isApplicable', () => {
    it('enabled features', () => {
      ...
      expect(
        new Library('com.launcher:auth-core:1.0').isApplicable(
          {},
          enabledFeatures
        )
      ).toBeTruthy();
